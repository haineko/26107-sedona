...
function initForm() {
  ...
  var btn_upload = document.getElementById('upload__photo'); // кнопка для добавления фотографий
...
//        var html = Mustache.render(templ_image, {
//            "image": event.target.result,
//            "name": file.name
//        });
        var source   = document.getElementById('image_template');
        var template = Handlebars.compile(source);
        
        var context = {image: event.target.result, name: file.name};
