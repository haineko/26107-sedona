...
function setState(savElement) {
  var name = savElement.getAttribute('name');
//Здесь ошибка со стиранием названия кнопки. затирается value
...
//delTraveler.addEventListener('click', function(e){
//  e.preventDefault();
//  delNewTraveler(-1, number_traveler);
//});
//
//addlTraveler.addEventListener('click', function(e){
//  e.preventDefault();
//  addNewTraveler(1, number_traveler);
//});
